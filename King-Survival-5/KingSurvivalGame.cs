...
﻿ namespace KingSurvivalGame
{
    ...
    {        private static bool IsPositionOnTheBoard(int[] positionCoodinates)
        ...
        static void CheckForKingExit(int currentKingXAxe)
        {
            if (currentKingXAxe == 2)
            {
                Console.WriteLine(Constants.EndGameMessage);
                Console.WriteLine(Constants.KingVictoryMessage, Counter / 2);
                GameOver = true;
            }
        }
...
>>>>>>> efaffe39c539e4865083d2b8825c92d2536c857e:King-Survival-5/KingSurvivalGame.cs
}